...
import colorsys
class Properties:
    colors = [(0.125,"red"), (0.25,"orange"), (0.375,"yellow"), (0.5,"green"), (0.625,"teal"), (0.75,"blue"),(0.875,"purple"), (1.,"pink")]
...
#----------------------------------------------------------najczęstszy kolor
    def trait_dominating_color(self, images):
        ...
        return self.colors[results.index(max(results))][1]
...
p = Properties()
p.load()
#print p.trait_avg_value(p.images)
#print p.trait_avg_value_change(p.images)
print p.trait_dominating_color(p.images)
